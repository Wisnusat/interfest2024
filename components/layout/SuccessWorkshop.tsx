    ...
    return (
        <div className="bg-gradient-to-b from-[#0B0B3B] via-[#1E0B3B] to-[#0B0B3B] min-h-screen text-gray-100 font-sans overflow-hidden py-20 px-4">
            ...
            <div className="max-w-3xl mx-auto pt-16 text-center space-y-6">
                ...
                >
                    <p className="text-xl mb-2 font-medium">Congratulations, your application for Workshop INTERFEST 2024 has been received!</p>
                    <p className="text-lg mb-4">Dont forget to join the Whatsapp Group Below:</p>
                    <a
                        href="https://chat.whatsapp.com/DKroXXVdAosGjovaHSAawF"
                        target="_blank"
                    ...
                    <p className="text-sm text-[#FFD700] font-medium mt-2">
